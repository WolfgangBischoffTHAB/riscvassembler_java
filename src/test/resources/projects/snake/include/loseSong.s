...
sw s1, 12(sp)
	...
	la s0,NUM_MUS_PERDEU		# define o endere�o do n�mero de notas
	lw s1,0(s0)		# le o numero de notas
	la s0,NOTAS_PERDEU		# define o endere�o das notas
	li t0,0			# zera o contador de notas
	#li a2,68		# define o instrumento
	li a2,0		# define o instrumento
	li a3,70		# define o volume

LOOPSOUND:	beq t0,s1, FIMSOUND	# contador chegou no final? ent�o  v� para FIM
